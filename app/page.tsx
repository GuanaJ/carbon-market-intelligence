...
type LivePlatformSnapshot = {
  beijingTime: string;
  status: string;
  collection: { moduleCount: number; sourceChecks: number; successCount: number; failedCount: number; protectedModuleCount: number; addedCount?: number; updatedCount?: number; manualReviewCount?: number; totalRecordCount?: number };
